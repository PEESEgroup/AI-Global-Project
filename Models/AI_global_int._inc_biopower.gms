...
eqPbio1.. sum(t,Pbio(t)) =l= Pratedbio*8760*0.6 ;
eqPbio2(t).. Pbio(t) =l= Pratedbio ;

eqPtotal(t).. Ptotal(t) =e= Psolarutilized(t)+Pwindutilized(t)+Pgrid(t)+Pdischarge(t)*cyceff+Pbioutilized(t);

eqPsolarutilized(t).. Psolarutilized(t) =l= Psolar(t) ; 
eqPwindutilized(t).. Pwindutilized(t) =l= Pwind(t) ;
eqPbioutilized(t).. Pbioutilized(t) =l= Pbio(t) ;
...
eqPbiototal.. Pbiototal =e= sum(t,Pbioutilized(t)); 
...
eqCbio.. Cbio =e= Pratedbio*ICbio ;
eqCtotal.. Ctotal =e= Csolar+Cwind+Cbattery+Cinterface+Cdac+Chpump+Cbio ;
...
eqOPEXbio.. OPEXbio =e= (Pratedbio*fbio + Pbiototal*vbio)*NY ; 
eqOPEXtotal.. OPEXtotal =e= OPEXsolar+OPEXwind+OPEXgrid+OPEXbattery+OPEXPenalty+OPEXinterface+OPEXdac+OPEXtransport+OPEXstorage+OPEXbio ;
...
eqlandconstraint.. Pgridtotal*land+Psolartotal*lus+Pwindtotal*luw+Pbiototal*lub =l= Paiatotal*land*ldi ;
