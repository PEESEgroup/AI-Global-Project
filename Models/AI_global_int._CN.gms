...
$call gdxxrw.exe Srd_AI_global_raw.xlsx par=radiation rng=sheet1!A1:LXY60 
...
$call gdxxrw.exe Wsp_AI_global_raw.xlsx par=speed rng=sheet1!A1:LXY60 
*=== Now import data from GDX
Parameter speed(i,t);
...
$call gdxxrw.exe PUE_AI_global_raw.xlsx par=pu rng=sheet1!A1:LXY60 
*=== Now import data from GDX
Parameter pu(i,t);
...
$call gdxxrw.exe CI_AI_global_raw.xlsx par=ci rng=sheet1!A1:I60
*=== Now import data from GDX
Parameter ci(i,n);
...
$call gdxxrw.exe LU_AI_global_raw.xlsx par=lu rng=sheet1!A1:I60
*=== Now import data from GDX
Parameter lu(i,n);
...
$call gdxxrw.exe PI_AI_global_raw.xlsx par=pri rng=sheet1!A1:BH2
*=== Now import data from GDX
Parameter pri(m,i);
...
$call gdxxrw.exe Cap_ratio.xlsx par=cpratio rng=sheet1!A1:BH2
*=== Now import data from GDX
