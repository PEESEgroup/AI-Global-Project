...
eqPheat(t).. Pheat(t) =e= hsupply(t)*LHV*effheater ;
eqPhrelation(t).. Pheat(t) =e= Pdac(t)*df ;
eqsoh(t).. hsupply(t) =l= captank ;

eqKheater(t).. Kheater =g= hsupply(t)*LHV  ; 
...
eqCheater.. Cheater =e= Kheater*ICheater*2 ;
eqChtank.. Chtank =e= captank*Ichtank ;
eqCtotal.. Ctotal =e= Csolar+Cwind+Cbattery+Cinterface+Cdac+Cheater+Chtank ;
...
eqOPEXheater.. OPEXheater =e= htfoc*Kheater*NY ;
eqOPEXhydrogen.. OPEXhydrogen =e= sum(t,hsupply(t))*hprice*NY ;
eqOPEXtank.. OPEXtank =e= Chtank*NY*0.17 ;
eqOPEXtotal.. OPEXtotal =e= OPEXsolar+OPEXwind+OPEXgrid+OPEXbattery+OPEXPenalty+OPEXinterface+OPEXdac+OPEXtransport+OPEXstorage+OPEXheater+OPEXhydrogen+OPEXtank ;

eqSALtotal.. SALtotal =e= (SALbattery+SALinterface+SALheater)/((1+d)**NY) ;
eqSALbattery.. SALbattery =e= nbattery*ICbattery*sbattery ; 
eqSALinterface.. SALinterface =e= capinterface*ICinterface*sinterface ;
eqSALheater.. SALheater =e= Kheater*ICheater*sheater ;
